...
<?php $headTitle = 'Reports by Status' ?>
<?php $mainTitle = "Reports by Status" ?>
<?php $breadcrumbs = " Reports by Status" ?>
<?php $menuParentSection = "evacuee-report" ?>
<?php $menuSection = "report-status" ?>
...
$statusArray = ['Normal', 'PWD', 'Pregnant', 'Sick', 'w/ special needs']
                        ...
                        <div class="card-body">
                            <table class="table table-bordered mytable">
                                ...
                                <?php foreach ($statusArray as $status) {
                                    ...
                                    $evacuees = $conn->query("SELECT * 
                                              FROM evacuees ev
                                              INNER JOIN barangay_info bi ON ev.person_id = bi.id 
                                            WHERE ev.status = 1 AND evacuation_center_id = $center_id AND remarks = '$status' $calamitySql")->fetch_all();
                                    ?>


                                    <tr>
                                        <td><?= $status ?></td>
                                        <td><?= count($evacuees) ?></td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
    $('#select_calamity').on('change', function(e) {
        ...
        window.location = `status-report.php?c=true&calamity_id=` +calamity_id + (center_id !== null ? `&center=` +center_id : '&center=5');
    });
    ...
    $('#select_evac').on('change', function(e) {
        ...
        window.location = `status-report.php?c=true&center=` +center_id + (calamity_id !== null ? `&calamity_id=` +calamity_id : '&calamity_id=1');
    });
